        ...
        <div className="flex justify-between">
          <div className="flex-1 flex-col">
            ...
            <div className="mb-4 mt-5">
              ...
              <textarea name="address" value={customer.address} onChange={handleChange} placeholder="Input address" className="shadow border rounded w-5/6 py-10 px-3 text-gray-700 focus:outline-none focus:shadow-outline"></textarea>
            </div>
            <div className="mb-4 mt-5">
          ...
          <div className="flex-1 flex-col">
            <div className="mb-4 mt-5">
              ...
              <select className="form-select px-10 py-2 border w-5/6 rounded-lg" name="level_id" value={customer.level_id} onChange={handleSelectChange}>
