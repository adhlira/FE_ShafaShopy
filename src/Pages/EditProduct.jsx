        ...
        <div className="flex justify-between">
          <div className="flex-1 flex-col">
            <div className="mb-4 mt-5">
              ...
              <select className="form-select px-10 py-2 border w-5/6 rounded-lg" name="category_id" value={product?.category_id} onChange={handleChange}>
            ...
            <div className="mb-4 mt-5">
              ...
              <select className="form-select px-10 py-2 border w-5/6 rounded-lg" name="color_id" value={product?.color_id} onChange={handleChange}>
                <option className="text-center md:text-base text-xs" value="">
                  Choose
                </option>
                {color.map((item) => (
