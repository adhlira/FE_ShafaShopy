    ...
    <>
      ...
      <form className="w-full max-w-lg mx-auto p-6 rounded shadow-md" onSubmit={handleSubmit}>
        <div className="mb-4 mt-5">
          ...
          <select className="form-select px-10 py-2 border w-full rounded-lg cursor-not-allowed" name="product_id" value={sellingPrice?.product_id} onChange={handleChange} disabled>
            <option className="md:text-base text-xs">{sellingPrice.Product?.name} - {sellingPrice.Product?.Color?.name}</option>
          </select>
        </div>
        <div className="mb-4 mt-5">
